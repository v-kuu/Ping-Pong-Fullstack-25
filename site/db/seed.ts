...
export default async function seed() {
  ...
  const matches = [
    { game: "pong", playerIds: [userIds[0], userIds[1]], scores: [3, 1] },
    { game: "pong", playerIds: [userIds[0], userIds[2]], scores: [2, 3] },
    { game: "pong", playerIds: [userIds[1], userIds[3]], scores: [1, 3] },
    { game: "pong", playerIds: [userIds[2], userIds[4]], scores: [0, 3] },
    { game: "pong", playerIds: [userIds[0], userIds[4]], scores: [3, 2] },
    { game: "pong", playerIds: [userIds[1], userIds[2]], scores: [3, 0] },
    { game: "pong", playerIds: [userIds[3], userIds[0]], scores: [4, 2] },
    { game: "pong", playerIds: [userIds[4], userIds[1]], scores: [3, 1] },
    { game: "pong", playerIds: [userIds[5], userIds[6]], scores: [2, 1] },
    { game: "pong", playerIds: [userIds[6], userIds[7]], scores: [1, 3] },
    { game: "web3d", playerIds: [userIds[0], userIds[1], userIds[2], userIds[3]], scores: [15, 12, 8, 5] },
    { game: "web3d", playerIds: [userIds[4], userIds[5], userIds[6]], scores: [20, 14, 10] },
    { game: "web3d", playerIds: [userIds[0], userIds[4], userIds[5], userIds[6], userIds[7]], scores: [12, 18, 9, 7, 11] },
    { game: "web3d", playerIds: [userIds[1], userIds[2]], scores: [8, 13] },
  ];
